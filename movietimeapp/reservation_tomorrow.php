...
<script type="text/javascript">
		...
		function reservation_tomorrow1()
		{     
            var showTomorrow = document.reservation_tomorrow.showTomorrow.value;
            ...
            loadXMLDoc("./userSql.php?movie_tomorrow="+info[1]+"&reservation_tomorrow="+1,function()
            {	
    	...
    	function reservation_tomorrow2(num_tomorrow)
		{
            document.cookie = 'movie_tomorrow_num =' + num_tomorrow;
            loadXMLDoc("./userSql.php?num_tomorrow="+num_tomorrow+"&reservation_tomorrow="+2,function()
            {	
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {	      
    	...
    	function reservation_tomorrow3(reservation_num,movie_tomorrow_num)
		{
            t_selectIndex = document.getElementById("showTomorrow").selectedIndex;  
            document.cookie = 't_selectIndex =' + t_selectIndex;
            
        	loadXMLDoc("./userSql.php?num_tomorrow="+reservation_num+"&reservation_tomorrow="+3,function()
            {	
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {	      
                    window.location.assign("reservation_tomorrow.php");
                    alert("删除预约成功！"); 
            	}
            });
    	}
        ...
        {  
        	...
        	{  
        		...
        		document.getElementById("showTomorrow").options[json.t_selectIndex].selected = true;  
            	...
            	loadXMLDoc("./userSql.php?movie_tomorrow="+info[1]+"&num_tomorrow="+json.movie_tomorrow_num+"&reservation_tomorrow="+4,function()
            	{	
                	if (xmlhttp.readyState==4 && xmlhttp.status==200)
                	{	
                    	var response = xmlhttp.responseText;
...
<div class="container">
  <div class="container_wrap">
    ...
    <div class="content">
      <form name="reservation_tomorrow" action="reservation_tomorrow.php" method="post">
        <?php
			error_reporting(0);
			session_start();
			...
			echo "<br><br><h1 class='m_2'>>>&nbsp预约管理</h1>
            		<a href='reservation.php' style='font-family:微软雅黑;font-size:16px;margin-left:70px'>今日预约</a>
                    <font style='font-size:17px'>&nbsp&nbsp|&nbsp&nbsp</font>
                    <font style='font-family:微软雅黑;font-size:16px;'>明日预约</font><br><br>";	
			?>
        ...
        <?php
			...
			else
			{
                ...
                echo "<font style='margin-left:210px'>明日播放：</font>
                <select name='showTomorrow' id='showTomorrow' onchange='reservation_tomorrow1()'>";
            	...
            	{
                    echo "<tr><td><a href='javascript:;' onclick='reservation_tomorrow2($row_info_first[3])' style='font-family:微软雅黑' >
