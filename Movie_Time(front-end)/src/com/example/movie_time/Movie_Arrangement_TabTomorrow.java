...
public class Movie_Arrangement_TabTomorrow extends ListActivity{
	...
	private ArrayList<HashMap<String, Object>> getData(String cinema, String movie){  
		...
		try {
			jArray = new JSONArray(
					sql.connectMysql("http://1.movietimeapp.sinaapp.com/movie_arrangement_tomorrow_sql.php"));
